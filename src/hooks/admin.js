...
export function getLogs(chronologyFilter, pagination) {
    return restInterceptor.post("/logger-service/admin/getAll", {
        ...
        createdAfter: chronologyFilter.createdAfter !== null ? chronologyFilter.createdAfter + "T00:00:00" : '',
        createdBefore: chronologyFilter.createdBefore !== null ? chronologyFilter.createdBefore + "T00:00:00" : '',
