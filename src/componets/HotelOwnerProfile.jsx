    ...
    return (
        <div>
            <div className={'register-box'}>
                <Form id={'owner'} onSubmit={saveOwner}>
                    <CommonInputText disabled={true} type={'text'} value={newOwner.email}
                                     label={t('email')}/>
                    <CommonInputText type={'text'} value={newOwner.fullName ? newOwner.fullName:""}
                                     label={t('fullName')} name={'fullName'} setObjectValue={setOwner}/>
                    <CommonInputText type={'text'} value={newOwner.companyName ? newOwner.companyName : ""}
                    ...
                    <CommonInputText type={'text'} value={newOwner.city ? newOwner.city : ""}
                                     label={t('city')} name={'city'} setObjectValue={setOwner}/>
                    <CommonInputText type={'text'} value={newOwner.companyAddress ? newOwner.companyAddress : ""}
                    ...
                    <CommonInputText type={'text'} value={newOwner.eik ? newOwner.eik : ""}
